...
classdef fine_stage_prototype1_propagation_layer < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods
        ...
        function layer = fine_stage_prototype1_propagation_layer(num_input,num_channel, name)
           %% setup unleanrable parameters
           layer.Name = name;
           layer.Description="fine stage protoype adaptive propagation layer";
           layer.NumInputs=num_input;
           layer.Num_chn=num_channel;
           layer.Weights=randn(1,1,num_channel);
           layer.Bias=randn
