...
function [dlnetwork_obj]=res_bottleneck_block(dlnetwork, layer_ind, num_cardinal,num_feat)
    
    %% grab out dlnetwork object
    dlnetwork_obj=dlnetwork;


    %% setup first main layer (original conv1+bn1+relu1 in the bottleneck)
    main_layer=[
