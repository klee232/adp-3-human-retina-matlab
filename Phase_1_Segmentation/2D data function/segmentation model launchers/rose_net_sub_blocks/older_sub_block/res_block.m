...
function [dlnetwork_obj]=res_block(dlnetwork, layer_ind, num_cardinal,num_feat)
    ...
    %% setup first main layer (checked)
    main_layer=[
        convolution2dLayer([3 3],num_feat,Padding="same",Name=strcat('main_layer_c1_',string(layer_ind)));
    ...
    for i_cardinal=1:num_cardinal
        ...
        res_block_first_branch=[
            ...
            convolution2dLayer([1 1],(num_feat/(2*num_cardinal)),Padding="same",Name=strcat('res_block_first_branch_b1m1c1_',string(layer_ind),"_",string(i_cardinal)));
            ...
            convolution2dLayer([3 3],(num_feat/(1*num_cardinal)),Padding="same",Name=strcat('res_block_first_branch_b1m1c2_',string(layer_ind), "_",string(i_cardinal)));
        ...
        res_block_second_branch=[
            ...
            convolution2dLayer([1 1],(num_feat/(2*num_cardinal)),Padding="same",Name=strcat('res_block_second_branch_b1m1c1_',string(layer_ind),"_",string(i_cardinal)));
            ...
            convolution2dLayer([3 3],(num_feat/(1*num_cardinal)),Padding="same",Name=strcat('res_block_second_branch_b1m1c2_',string(layer_ind),"_",string(i_cardinal)));
