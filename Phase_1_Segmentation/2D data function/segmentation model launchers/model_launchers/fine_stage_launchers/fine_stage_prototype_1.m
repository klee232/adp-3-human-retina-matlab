function network=fine_stage_prototype_1(input)
    ...
    dil_conv_org_br1=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[1 1],Name="org_b1_c1",Padding="same");
    ...
    % branch 2
    dil_conv_org_br2=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[2 2],Name="org_b2_c1",Padding="same");
    ...
    % branch 3
    dil_conv_org_br3=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[4 4],Name="org_b3_c1",Padding="same");
    ...
    % concatenation
    cat_org=[
         concatenationLayer(3,4,"Name","org_cat");
    ];
    ...
    %% branch thick
    input_thk_split=[
        fine_block_input_split_layer("thk_input",2);
    ];
    network=addLayers(network,input_thk_split);
    network=connectLayers(network, 'input_lyr_1','thk_input'); 
    dil_conv_thk_br1=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[2 2],Name="thk_b1_c1",Padding="same");
        batchNormalizationLayer(Name="thk_b1_b1");
        reluLayer(Name="thk_b1_a1");
        ];
    network=addLayers(network,dil_conv_thk_br1);
    network=connectLayers(network, 'thk_input','thk_b1_c1'); 
    % branch 2
    dil_conv_thk_br2=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[4 4],Name="thk_b2_c1",Padding="same");
        batchNormalizationLayer(Name="thk_b2_b1");
        reluLayer(Name="thk_b2_a1");
        ];
    network=addLayers(network,dil_conv_thk_br2);
    network=connectLayers(network, 'thk_input','thk_b2_c1');
    % branch 3
    dil_conv_thk_br3=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[6 6],Name="thk_b3_c1",Padding="same");
        batchNormalizationLayer(Name="thk_b3_b1");
        reluLayer(Name="thk_b3_a1");
        ];
    network=addLayers(network,dil_conv_thk_br3);
    network=connectLayers(network, 'thk_input','thk_b3_c1');
    % concatenation
    cat_thk=[
         concatenationLayer(3,4,"Name","thk_cat");
    ];
    network=addLayers(network,cat_thk);
    network=connectLayers(network, 'thk_b1_a1','thk_cat/in1');
    network=connectLayers(network, 'thk_b2_a1','thk_cat/in2');
    network=connectLayers(network, 'thk_b3_a1','thk_cat/in3');
    % fusion
    conv_fuse_thk=[
        convolution2dLayer([1 1],64,"WeightsInitializer",'he',Name="fuse_thk_c1",Padding="same");
        batchNormalizationLayer(Name="fuse_thk_b1");
        reluLayer(Name="fuse_thk_a1");
        ];
    network=addLayers(network,conv_fuse_thk);
    network=connectLayers(network, 'thk_cat','fuse_thk_c1');


    %% branch thin
    input_thn_split=[
        fine_block_input_split_layer("thn_input",3);
    ];
    network=addLayers(network,input_thn_split);
    network=connectLayers(network, 'input_lyr_1','thn_input'); 
    dil_conv_thn_br1=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[1 1],Name="thn_b1_c1",Padding="same");
    ...
    % branch 2
    dil_conv_thn_br2=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[2 2],Name="thn_b2_c1",Padding="same");
    ...
    % branch 3
    dil_conv_thn_br3=[
        convolution2dLayer([3 3],64,"WeightsInitializer",'he','DilationFactor',[3 3],Name="thn_b3_c1",Padding="same");
    ...
    % concatenation
    cat_thn=[
         concatenationLayer(3,4,"Name","thn_cat");
    ];
   ...
   % concatenation
   cat_all=[
         concatenationLayer(3,4,"Name","all_cat");
    ];
    network=addLayers(network,cat_all);
    network=connectLayers(network, 'fuse_org_a1','all_cat/in1');
    network=connectLayers(network, 'fuse_thk_a1','all_cat/in2');
    network=connectLayers(network, 'fuse_thn_a1','all_cat/in3');
    % fusion
    conv_fuse=[
        ...
        convolution2dLayer([1 1],3,"WeightsInitializer",'he',Name="fuse_c2",Padding="same");
