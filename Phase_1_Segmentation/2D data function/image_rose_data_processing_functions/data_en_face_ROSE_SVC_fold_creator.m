...
function [fold_train_data_storage, fold_valid_data_storage, ...
          fold_train_gt_storage, fold_valid_gt_storage,...
          fold_train_thick_gt_storage, fold_valid_thick_gt_storage,...
          fold_train_thin_gt_storage, fold_valid_thin_gt_storage]=data_en_face_ROSE_SVC_fold_creator(train_data_storage, train_gt_storage, train_thick_gt_storage, train_thin_gt_storage,...
                                                                                                     valid_data_storage, valid_gt_storage, valid_thick_gt_storage, valid_thin_gt_storage,num_fold)
    ...
    thick_gt_storage=cat(3,train_thick_gt_storage,valid_thick_gt_storage);
    thin_gt_storage=cat(3,train_thin_gt_storage,valid_thin_gt_storage);
    ...
    % thick gt storage
    fold_train_thick_gt_storage=zeros(img_row, img_col, num_train_file,num_fold);
    fold_valid_thick_gt_storage=zeros(img_row, img_col, num_valid_file,num_fold);

    % thin gt storage
    fold_train_thin_gt_storage=zeros(img_row, img_col, num_train_file,num_fold);
    fold_valid_thin_gt_storage=zeros(img_row, img_col, num_valid_file,num_fold);
    ...
    for i_fold=1:num_fold
        ...
        fold_valid_thick_gt_storage(:,:,:,i_fold)=thick_gt_storage(:,:,valid_ind);
        fold_valid_thin_gt_storage(:,:,:,i_fold)=thin_gt_storage(:,:,valid_ind);
        ...
        fold_train_thick_gt_storage(:,:,:,i_fold)=thick_gt_storage(:,:,train_ind);
        fold_train_thin_gt_storage(:,:,:,i_fold)=thin_gt_storage(:,:,train_ind);
