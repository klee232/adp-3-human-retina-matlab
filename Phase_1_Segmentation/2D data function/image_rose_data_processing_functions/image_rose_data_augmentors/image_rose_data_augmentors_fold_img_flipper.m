...
function [augmentated_data, augmentated_gt_data]=image_rose_data_augmentors_fold_img_flipper(data, gt_data)
    ...
    augmentated_gt_data=zeros(num_row,num_col, num_sample*3, num_fold);
