...
function [test_image_array]=image_rose_data_ROSE_test_process(data_pathway,filetype)
    ...
    test_image_array=zeros(row_img,col_img,num_files);
    ...
    for i_file=1:num_files
        ...
        test_image_array(:,:,i_file)=current_image;
