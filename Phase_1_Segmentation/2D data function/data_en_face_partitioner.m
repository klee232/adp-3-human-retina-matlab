...
function [train_data_storage, valid_data_storage, test_data_storage,...
          train_label_gt_storage,valid_label_gt_storage,test_label_gt_storage]=data_en_face_partitioner(data_storage,label_gt_storage,num_fold,Test_ratio)
    ...
    for i_fold=1:num_fold
        ...
        valid_data_storage(:,:,:,:,i_fold)=data_storage(:,:,:,valid_ind(i_fold,:));  
        ...
        train_data_storage(:,:,:,:,i_fold)=data_storage(:,:,:,train_ind(i_fold,:)); 
