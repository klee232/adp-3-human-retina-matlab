...
% This function is built to compute the testing criteria: FDR
...
function testing_function_pixel_FDR(trained_coarse_network, trained_fine_network, test_data, test_gt_data, lyr)
    ...
    for i_test_data=1:num_test_data
        ...
        % compute FDR
        current_FDR=(FP)/(TP+FP+eps);
        total_FDR=total_FDR+current_FDR;
    end


    %% compute accuracy
    FDR=total_FDR/num_test_data;
    msg=strcat("Current layer: ", lyr," , FDR: ", num2str(FDR));
    disp(msg);
