...
% This function is built to compute the testing criteria: Dice
...
function testing_function_pixel_diceScore(trained_coarse_network, trained_fine_network, test_data, test_gt_data, lyr)
    ...
    for i_test_data=1:num_test_data
        ...
        % compute Kappa
        current_dice=(2*TP)/(2*TP+FP+FN+eps);
        total_dice=total_dice+current_dice;
    end


    %% compute accuracy
    dice=total_dice/num_test_data;
    msg=strcat("Current layer: ", lyr," , dice: ", num2str(dice));
    disp(msg);
