...
function trained_network=training_function_SVC_coarse_f2(network, orig_data, orig_thick_gt_data, orig_thin_gt_data, orig_valid_data, orig_valid_thick_gt_data, orig_valid_thin_gt_data,num_epoch,learning_rate,lyr)
    ...
    if exist("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2","dir")
       % check if the directory is empty
       contents=dir("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2");
       contents=contents(~ismember({contents.name},{'.','..'}));
       is_empty=isempty(contents);
       % if not empty load the file
       if ~is_empty    
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/net.mat");
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_fold.mat");
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_sample.mat");
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/epoch.mat");
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/train_loss.mat");
           load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/valid_loss.mat");
           start_epoch=epoch;
           start_fold=i_fold;
           start_sample=i_sample;
           if start_sample~=1 && start_epoch~=1
              load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_loss.mat");
              load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_gradient.mat");
              load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_gradient.mat");
              load("Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_squared_gradient.mat");
           end
    ...
    for i_fold=start_fold:num_fold
        ...
        for epoch = start_epoch:num_epoch
            ...
            for i_sample=start_sample:num_sample
                ...
                if ~exist("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2","dir")
                    mkdir("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2")
                end

                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_loss.mat","accumulated_loss","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_gradient.mat","accumulated_gradient","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_gradient.mat","average_gradient","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_squared_gradient.mat","average_squared_gradient","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/net.mat","net_storage","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_fold.mat","i_fold","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_sample.mat","i_sample","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/epoch.mat","epoch","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/train_loss.mat","train_loss","-v7.3")
                save ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/valid_loss.mat","valid_loss","-v7.3")

            end % end of sample

            % save current training and validation loss
            save ("~/data/klee232/train_en_face_seg_loss/coarse_stage_model_4_f2_SVC_Noweightdecay_noaug_msePlustversky_train_loss.mat", "train_loss")
            save ("~/data/klee232/valid_en_face_seg_loss/coarse_stage_model_4_f2_SVC_Noweightdecay_noaug_msePlustversky_valid_loss.mat", "valid_loss")
    ...
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/net.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_fold.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/epoch.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/i_sample.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/train_loss.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/valid_loss.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_loss.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/accumulated_gradient.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_gradient.mat");
    delete ("~/GitHub/adp-3-human-retina/Phase_1_Segmentation/2D data function/training_and_testing_functions/SVC_coarse_temp_f2/average_squared_gradient.mat");

    % save the trained neural network and delete the intermediate file
    stored_data_path="~/data/klee232/trained_en_face_seg_model/";
    prototype_name="trained_coarse_stage_model_4_f2_Noweightdecay_";
    layer_trained=lyr;
    augemented="_noaug";
    ...
    for i_fold=2:num_fold
        ...
        prototype_name="coarse_stage_model_4_f2_Noweightdecay_";
        layer_trained=lyr;
        augemented="_noaug";
