...
function trained_network=training_function_SVC_fine(network, trained_coarse_network, orig_data, orig_gt_data, orig_valid_data, orig_valid_gt_data,num_epoch,learning_rate,lyr)
    ...
    for i_fold=start_fold:num_fold
        ...
        save ("~/data/klee232/train_en_face_seg_loss/fine_stage_prototype_256_SVC_triaug_tversky_bce_train_loss.mat", "train_loss")
        save ("~/data/klee232/valid_en_face_seg_loss/fine_stage_prototype_256_SVC_triaug_tversky_bce_valid_loss.mat", "valid_loss")
    end % end of fold
    ...
    prototype_name="trained_fine_prototype_model_256_";
