...
function [dlnetwork_obj]=res_block(dlnetwork, layer_ind, num_cardinal,num_feat)
    
    %% grab out dlnetwork object
    dlnetwork_obj=dlnetwork;


    %% setup first main layer
    main_layer=[
        convolution3dLayer([1 3 3],num_feat,Padding="same",Name=strcat('main_layer_c1_',string(layer_ind)));
        batchNormalizationLayer(Name=strcat('main_layer_b1_',string(layer_ind)));
        reluLayer(Name=strcat('main_layer_a1_',string(layer_ind)));
    ];
    ...
    first_split_block_first=[
        input_spilit_first_res_block_layer(strcat("res_block_first_branch_",string(layer_ind)));
    ];
    dlnetwork_obj=addLayers(dlnetwork_obj,first_split_block_first);
    dlnetwork_obj=connectLayers(dlnetwork_obj,strcat('main_layer_a1_',string(layer_ind)),strcat("res_block_first_branch_",string(layer_ind)));

    first_split_block_second=[
        input_spilit_second_res_block_layer(strcat("res_block_second_branch_",string(layer_ind)));
    ];
    dlnetwork_obj=addLayers(dlnetwork_obj,first_split_block_second);
    dlnetwork_obj=connectLayers(dlnetwork_obj,strcat('main_layer_a1_',string(layer_ind)),strcat("res_block_second_branch_",string(layer_ind)));
    ...
    for i_cardinal=1:num_cardinal
        ...
        res_block_first_branch=[
            input_spilit_first_res_block_layer(strcat("res_block_first_branch_",string(layer_ind), "_", string(i_cardinal)));
            convolution3dLayer([1 3 3],(num_feat/(2*num_cardinal)),Padding="same",Name=strcat('res_block_first_branch_b1m1c1_',string(layer_ind),"_",string(i_cardinal)));
            batchNormalizationLayer(Name=strcat('res_block_first_branch_b1m1b1_',string(layer_ind), "_", string(i_cardinal)));
            reluLayer(Name=strcat('res_block_first_branch_b1m1a1_',string(layer_ind), "_",string(i_cardinal)));
            convolution3dLayer([1 3 3],(num_feat/(1*num_cardinal)),Padding="same",Name=strcat('res_block_first_branch_b1m1c2_',string(layer_ind), "_",string(i_cardinal)));
            batchNormalizationLayer(Name=strcat('res_block_first_branch_b1m1b2_',string(layer_ind),"_",string(i_cardinal)));
            reluLayer(Name=strcat('res_block_first_branch_b1m1a2_',string(layer_ind),"_",string(i_cardinal)));
        ];
        dlnetwork_obj=addLayers(dlnetwork_obj,res_block_first_branch);


        %% second branch of resnest block
        res_block_second_branch=[
            input_spilit_second_res_block_layer(strcat("res_block_second_branch_",string(layer_ind), "_",string(i_cardinal)));
            convolution3dLayer([1 3 3],(num_feat/(2*num_cardinal)),Padding="same",Name=strcat('res_block_second_branch_b1m1c1_',string(layer_ind),"_",string(i_cardinal)));
            batchNormalizationLayer(Name=strcat('res_block_second_branch_b1m1b1_',string(layer_ind),"_",string(i_cardinal)));
            reluLayer(Name=strcat('res_block_second_branch_b1m1a1_',string(layer_ind),"_",string(i_cardinal)));
            convolution3dLayer([1 3 3],(num_feat/(1*num_cardinal)),Padding="same",Name=strcat('res_block_second_branch_b1m1c2_',string(layer_ind),"_",string(i_cardinal)));
            batchNormalizationLayer(Name=strcat('res_block_second_branch_b1m1b2_',string(layer_ind),"_",string(i_cardinal)));
            reluLayer(Name=strcat('res_block_second_branch_b1m1a2_',string(layer_ind),"_",string(i_cardinal)));
        ];
        dlnetwork_obj=addLayers(dlnetwork_obj,res_block_second_branch);

        if i_cardinal==1
            dlnetwork_obj=connectLayers(dlnetwork_obj, strcat("res_block_first_branch_",string(layer_ind)), strcat("res_block_first_branch_",string(layer_ind), "_", string(i_cardinal)));
            dlnetwork_obj=connectLayers(dlnetwork_obj, strcat("res_block_first_branch_",string(layer_ind)), strcat("res_block_second_branch_",string(layer_ind), "_", string(i_cardinal)));
        else
            dlnetwork_obj=connectLayers(dlnetwork_obj, strcat("res_block_second_branch_",string(layer_ind)), strcat("res_block_first_branch_",string(layer_ind), "_", string(i_cardinal)));
            dlnetwork_obj=connectLayers(dlnetwork_obj, strcat("res_block_second_branch_",string(layer_ind)), strcat("res_block_second_branch_",string(layer_ind), "_", string(i_cardinal)));
        end


        %% split attention additional branch
        res_block_split_atten_add_branch=[
            additionLayer(2,Name=strcat('res_block_split_atten_add_',string(layer_ind),"_",string(i_cardinal)));
        ...
        dlnetwork_obj=connectLayers(dlnetwork_obj, strcat('res_block_split_atten_avg_pool_',string(layer_ind),"_", string(i_cardinal)), strcat('res_block_split_atten_branch_1_fc_',string(layer_ind),"_",string(i_cardinal)));
        dlnetwork_obj=addLayers(dlnetwork_obj,res_block_split_atten_add_branch_2);
        dlnetwork_obj=connectLayers(dlnetwork_obj, strcat('res_block_split_atten_avg_pool_',string(layer_ind),"_",string(i_cardinal)), strcat('res_block_split_atten_branch_2_fc_',string(layer_ind),"_",string(i_cardinal)));
    ...
    res_block_final_cat=[
        concatenationLayer(4,num_cardinal,Name=strcat('res_block_final_cat_',string(layer_ind)));
    ];
    ...
    res_block_final_add=[
        ...
        maxPooling3dLayer([1 2 2],Stride=[1 2 2],Name=strcat('res_block_final_max_',string(layer_ind)));
    ];
    dlnetwork_obj=addLayers(dlnetwork_obj,res_block_final_add);
    dlnetwork_obj=connectLayers(dlnetwork_obj, strcat('res_block_final_cat_',string(layer_ind)), strcat('res_block_final_add_',string(layer_ind),'/in1'));
