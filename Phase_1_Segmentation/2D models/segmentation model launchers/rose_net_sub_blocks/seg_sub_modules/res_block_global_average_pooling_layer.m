...
classdef res_block_global_average_pooling_layer < nnet.layer.Layer & nnet.layer.Formattable
    
    methods

        %% Constructor for the layer
        function layer = res_block_global_average_pooling_layer(name)
           layer.Name = name;
