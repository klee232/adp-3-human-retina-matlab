...
function [network]=coarse_stage_prototype_DVC(input)
    ...
    layerinput_b=[
        ...
        % maxPooling2dLayer([2 2],Stride=[2 2], Padding=[1 1],Name='input_lyr_max');
    ];
    ...
    num_feat=[128 256];
    num_block=[3 4];
    % layer 1: (304*304), layer 2: (152*152)
    ...
    for i_layer=(num_layer):(-1):1
         ...
         res_dblock_transcat=[
             ...
             res_dblock_spatial_dropout_layer(strcat('res_dblock_drop_',string(i_layer)),0.2);
         ];
