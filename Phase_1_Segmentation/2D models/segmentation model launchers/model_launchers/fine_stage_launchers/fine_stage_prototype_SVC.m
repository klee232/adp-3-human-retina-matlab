function network=fine_stage_prototype_SVC(input)
    ...
    dil_conv_thk_br1=[
        convolution2dLayer([3 3],256,"WeightsInitializer",'he','DilationFactor',[2 2],Name="thk_b1_c1",Padding="same");
    ...
    % branch 2
    dil_conv_thk_br2=[
        convolution2dLayer([3 3],256,"WeightsInitializer",'he','DilationFactor',[4 4],Name="thk_b2_c1",Padding="same");
    ...
    % branch 3
    dil_conv_thk_br3=[
        convolution2dLayer([3 3],256,"WeightsInitializer",'he','DilationFactor',[6 6],Name="thk_b3_c1",Padding="same");
    ...
    % concatenation
    cat_thk=[
         concatenationLayer(3,3,"Name","thk_cat");
    ];
   ...
   % concatenation
   cat_all=[
         concatenationLayer(3,3,"Name","all_cat");
    ];
