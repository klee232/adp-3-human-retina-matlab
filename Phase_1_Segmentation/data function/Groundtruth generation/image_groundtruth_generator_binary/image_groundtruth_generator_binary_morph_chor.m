...
function [p2,binary_choroid_image]=image_groundtruth_generator_binary_morph_chor(p2,choroid_image)
   ...
   %% conduct binarization for  choroid layer image
    ...
    for i_choroid_slice=1:num_choroid_slice
        ...
        current_choroid_slice_binary=imbinarize(current_choroid_slice);
        binary_choroid_image(i_choroid_slice,:,:)=imopen(current_choroid_slice_binary,strel('disk',5));
    end
