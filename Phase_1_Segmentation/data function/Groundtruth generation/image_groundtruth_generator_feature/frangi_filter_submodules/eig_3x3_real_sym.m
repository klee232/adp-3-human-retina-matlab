%% Created by Xiang Ji (Vectorized 3D Frangi Filter from MATLAB function exchange)
%% https://www.mathworks.com/matlabcentral/fileexchange/127564-vectorized-3d-frangi-filter



function [eig1, eig2, eig3] = eig_3x3_real_sym(A11, A12, A13, A22, A23, A33, eig_order)
% eig_3x3_real_sym(A11, A12, A13, A22, A23,
% A33) vectorizes the computation of the eigenvalues of 3 x 3 real
% symmetric matrices
% | A11, A12, A13|
% | A12, A22, A23|
% | A13, A23, A33|
% using the analytical method described in the reference.
% Input: 
%   Aij: numerical array, the (i,j) element of the matrics
...
% 
% Output: 
%   eig1, eig2, eig3: numerical array, three eigenvalues in specified
%   order
%
% Reference: 
