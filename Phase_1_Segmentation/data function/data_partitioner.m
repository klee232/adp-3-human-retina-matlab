...
function [train_data_storage, valid_data_storage, test_data_storage,...
          train_label_gt_storage,valid_label_gt_storage,test_label_gt_storage]=data_partitioner(data_storage,label_gt_storage,num_fold,Test_ratio)
    ...
    for i_test=1:num_test_file
        ...
        if iscell(current_test_data_img)
            ...
            test_data_storage(:,:,:,i_test,1)=current_test_data_img;
        else
            test_data_storage(:,:,:,i_test,1)=current_test_data_img;
        end
    end
    ...
    for i_fold=1:num_fold
        ...
        for i_valid=1:num_valid_file
            ...
            if iscell(current_valid_data_img)
                ...
                valid_data_storage(:,:,:,i_valid,i_fold)=current_valid_data_img;
            else
                valid_data_storage(:,:,:,i_valid,i_fold)=current_valid_data_img;
            end
        end
        ...
        for i_train=1:num_train_file
            ...
            if iscell(current_train_data_img)
                ...
                train_data_storage(:,:,:,i_train,i_fold)=current_train_data_img;
            else
                train_data_storage(:,:,:,i_train,i_fold)=current_train_data_img;
            end
        end
