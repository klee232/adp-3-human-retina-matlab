...
p1.uid = "jonghwan";
p1.eid = "220324-example";  p1.did = "SPECTRALIS_-_OCTA_C_1";
p1.eid = "231208-demo";  p1.did = "SPECTRALIS_-_OCTA_V_348";


p1.id = sprintf("%s-%s", p1.did, p1suff);
...
SaveFig(fig, false, "#recon", sprintf("%s #recon", p1.pathrepo));
...
SaveFig(figAng, false, "#reconAng", sprintf("%s #reconAng", p1.pathrepo));
