...
% This function is built to launch the spectral branch of classifier neural network for
% calssification
...
function network=spatial_neural_net_launcher(img_depth, img_row, img_col)
    ...
    layers_lv1=[
        ...
        image3dInputLayer([img_depth img_row img_col],Normalization="none",Name="spa_input_lyr");
        % convolutional and relu layer
        convolution3dLayer([1 3 3],2,Padding="same",Name='spa_conv_lyr_lv1');
   ...
   network=connectLayers(network, 'spa_input_lyr', 'spa_cat_lyr_lv1/in2');
   ...
   layers_z_lv5=[
       convolution3dLayer([3 1 1],3,Padding="same",Name='spa_conv_lyr_z_lv5');
