...
classdef patch_former_layer < nnet.layer.Layer
    ...
    methods
        ...
        function layer = patch_former_layer(name,patch_size)
           layer.Name = name;
           layer.Description = "patch_forming_lyr";
        ...
        function output=predict(layer, input)
            ...
            if pad_row_size~=0 || pad_col_size~=0
                ...
                for i_dep=1:depth_input
                    ...
                    pad_current_input=padarray(current_input,[pad_row_size pad_col_size],0,'both');
            ...
            output=zeros(depth_input,layer.Patch_size, layer.Patch_size, (factor_row*factor_col));

            % extract each patch range
            patch_ind=1; 
            for i_row=1:layer.Patch_size:pad_input_row
                for i_col=1:layer.Patch_size:pad_input_col
                    current_patch_input=pad_input(:,i_row:(i_row+layer.Patch_size),i_col:(i_col+layer.Patch_size));
