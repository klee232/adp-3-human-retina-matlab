...
% This function is built to launch the spectral attention branch classifier neural network for
% calssification
...
function network=spectral_neural_net_launcher(img_depth, img_row, img_col)
    ...
    layers_lv1=[
        ...
        image3dInputLayer([img_depth img_row img_col],Normalization="none",Name="spe_input_lyr");
   ...
   network=connectLayers(network, 'spe_input_lyr', 'spe_cat_lyr_lv1/in2');
   ...
   layers_z_lv2=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_z_lv2');
   ...
   layers_lv3=[
    ...
    layers_z_lv3=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_z_lv3');
   ...
   layers_z_lv4=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_z_lv4');
   ...
   layers_z_lv5=[
       convolution3dLayer([1 3 3],3,Padding="same",Name='spe_conv_lyr_z_lv5');
