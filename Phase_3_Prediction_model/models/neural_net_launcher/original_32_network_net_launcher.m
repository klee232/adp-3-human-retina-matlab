...
function network=original_32_network_net_launcher(img_depth, img_row, img_col)
    ...
    layers_lv1=[
        ...
        convolution3dLayer([1 3 3],32,Padding="same",Name='conv_lyr_lv1');
   ...
   layers_lv2=[
       convolution3dLayer([1 3 3],64,Padding="same",Name='conv_lyr_xy_lv2');
       reluLayer(Name='relu_lyr_xy_lv2');
       ];
   layers_z_lv2=[
       convolution3dLayer([3 1 1],32,Padding="same",Name='conv_lyr_z_lv2');
   ...
   layers_lv3=[
       ...
       convolution3dLayer([1 3 3],64,Padding="same",Name='conv_lyr_xy_lv3');
       reluLayer(Name='relu_lyr_xy_lv3');
       
       ];
    layers_z_lv3=[
       convolution3dLayer([3 1 1],32,Padding="same",Name='conv_lyr_z_lv3');
   ...
   layers_lv4=[
       ...
       convolution3dLayer([1 3 3],64,Padding="same",Name='conv_lyr_xy_lv4');
       reluLayer(Name='relu_lyr_xy_lv4');
       
    ];
   layers_z_lv4=[
       convolution3dLayer([3 1 1],32,Padding="same",Name='conv_lyr_z_lv4');
   ...
   layers_lv5=[
       ...
       convolution3dLayer([1 3 3],96,Padding="same",Name='conv_lyr_xy_lv5');
       reluLayer(Name='relu_lyr_xy_lv5');
    ];
   layers_z_lv5=[
       convolution3dLayer([3 1 1],48,Padding="same",Name='conv_lyr_z_lv5');
