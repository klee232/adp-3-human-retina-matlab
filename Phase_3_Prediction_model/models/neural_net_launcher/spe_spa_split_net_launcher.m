...
function network=third_main_neural_net_launcher(img_depth, img_row, img_col)
    ...
    layers_lv1=[
        ...
        convolution3dLayer([3 1 1],2,Padding="same",Name='spe_conv_lyr_lv1');
   ...
   % layers_lv2=[
   %     convolution3dLayer([3 1 1],4,Padding="same",Name='spe_conv_lyr_xy_lv2');
   %     reluLayer(Name='spe_relu_lyr_xy_lv2');
   %     ];
   layers_xy_lv2=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_xy_lv2');
       reluLayer(Name='spe_relu_lyr_xy_lv2');
   ];
   % network=addLayers(network,layers_lv2);
   network=addLayers(network,layers_xy_lv2);
   ...
   network=connectLayers(network, 'spe_max_lyr_lv1', 'spe_cat_lyr_lv2/in2');
    
   %% level 3
   % setup convolutional layer
   layers_lv3=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spe_conv_lyr_red_lv3');
       % convolution3dLayer([3 1 1],4,Padding="same",Name='spe_conv_lyr_xy_lv3');
       reluLayer(Name='spe_relu_lyr_red_lv3');
       ];
    layers_xy_lv3=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_xy_lv3');
       reluLayer(Name='spe_relu_lyr_xy_lv3');
    ];
   network=addLayers(network,layers_lv3);
   network=addLayers(network,layers_xy_lv3);
   network=connectLayers(network, 'spe_max_lyr_lv2', 'spe_conv_lyr_red_lv3');
   network=connectLayers(network, 'spe_conv_lyr_red_lv3', 'spe_conv_lyr_xy_lv3');
   ...
   network=connectLayers(network, 'spe_relu_lyr_red_lv3', 'spe_cat_lyr_lv3/in2');

   %% level 4
   % setup convolutional layer
   layers_lv4=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spe_conv_lyr_red_lv4');
       % convolution3dLayer([3 1 1],4,Padding="same",Name='spe_conv_lyr_xy_lv4');
       reluLayer(Name='spe_relu_lyr_red_lv4');
       
    ];
   layers_xy_lv4=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_xy_lv4');
       reluLayer(Name='spe_relu_lyr_xy_lv4');
   ];
   network=addLayers(network,layers_lv4);
   network=addLayers(network,layers_xy_lv4);
   network=connectLayers(network, 'spe_max_lyr_lv3', 'spe_conv_lyr_red_lv4');
   network=connectLayers(network, 'spe_conv_lyr_red_lv4', 'spe_conv_lyr_xy_lv4');
   % setup concatenational layer
   layers_cat_lv4=[
   ...
   network=connectLayers(network, 'spe_relu_lyr_red_lv4', 'spe_cat_lyr_lv4/in2');
    
   %% level 5
   % setup convolutional layer
   layers_lv5=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spe_conv_lyr_red_lv5');
       % convolution3dLayer([3 1 1],6,Padding="same",Name='spe_conv_lyr_xy_lv5');
       reluLayer(Name='spe_relu_lyr_red_lv5');
    ];
   layers_xy_lv5=[
       convolution3dLayer([1 3 3],2,Padding="same",Name='spe_conv_lyr_xy_lv5');
       reluLayer(Name='spe_relu_lyr_xy_lv5');
   ];
   network=addLayers(network,layers_lv5);
   network=addLayers(network,layers_xy_lv5);
   network=connectLayers(network, 'spe_max_lyr_lv4', 'spe_conv_lyr_red_lv5');
   network=connectLayers(network, 'spe_conv_lyr_red_lv5', 'spe_conv_lyr_xy_lv5');
   ...
   network=connectLayers(network, 'spe_relu_lyr_red_lv5', 'spe_cat_lyr_lv5/in2');
   ...
   layers_class_lv=[
    ...
    layers_lv1=[
        % setup image input layer
        % convolutional and relu layer
        convolution3dLayer([3 1 1],2,Padding="same",Name='spa_conv_lyr_lv1');
    ...
    layers_cat_lv1=[
        ...
        maxPooling3dLayer([2 1 1],Stride=2,Name="spa_max_lyr_lv1");
        ];
   network=addLayers(network,layers_cat_lv1);
   ...
   % setup convolutional layer
   % layers_lv2=[
   %     convolution3dLayer([1 3 3],4,Padding="same",Name='spa_conv_lyr_xy_lv2');
   %     reluLayer(Name='spa_relu_lyr_xy_lv2');
   %     ];
   layers_z_lv2=[
       convolution3dLayer([3 1 1],2,Padding="same",Name='spa_conv_lyr_z_lv2');
   ...
   network=addLayers(network,layers_cat_lv2);
   network=connectLayers(network, 'spa_relu_lyr_z_lv2', 'spa_cat_lyr_lv2/in1');
   % network=connectLayers(network, 'spa_relu_lyr_z_lv2', 'spa_cat_lyr_lv2/in2');
   network=connectLayers(network, 'spa_max_lyr_lv1', 'spa_cat_lyr_lv2/in2');
    
   %% level 3
   % setup convolutional layer
   layers_lv3=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spa_conv_lyr_red_lv3');
       % convolution3dLayer([1 3 3],4,Padding="same",Name='spa_conv_lyr_xy_lv3');
       reluLayer(Name='spa_relu_lyr_red_lv3');
       
       ];
    layers_z_lv3=[
       convolution3dLayer([3 1 1],2,Padding="same",Name='spa_conv_lyr_z_lv3');
   ...
   network=connectLayers(network, 'spa_relu_lyr_z_lv3', 'spa_cat_lyr_lv3/in1');
   network=connectLayers(network, 'spa_relu_lyr_red_lv3', 'spa_cat_lyr_lv3/in2');

   %% level 4
   % setup convolutional layer
   layers_lv4=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spa_conv_lyr_red_lv4');
       % convolution3dLayer([1 3 3],4,Padding="same",Name='spa_conv_lyr_xy_lv4');
       reluLayer(Name='spa_relu_lyr_red_lv4');
       
    ];
   layers_z_lv4=[
       convolution3dLayer([3 1 1],2,Padding="same",Name='spa_conv_lyr_z_lv4');
   ...
   network=connectLayers(network, 'spa_relu_lyr_z_lv4', 'spa_cat_lyr_lv4/in1');
   network=connectLayers(network, 'spa_relu_lyr_red_lv4', 'spa_cat_lyr_lv4/in2');
    
   %% level 5
   % setup convolutional layer
   layers_lv5=[
       convolution3dLayer([1 1 1],1,Padding="same",Name='spa_conv_lyr_red_lv5');
       % convolution3dLayer([1 3 3],6,Padding="same",Name='spa_conv_lyr_xy_lv5');
       reluLayer(Name='spa_relu_lyr_red_lv5');
    ];
   layers_z_lv5=[
       convolution3dLayer([3 1 1],2,Padding="same",Name='spa_conv_lyr_z_lv5');
   ...
   network=connectLayers(network, 'spa_relu_lyr_z_lv5', 'spa_cat_lyr_lv5/in1');
   network=connectLayers(network, 'spa_relu_lyr_red_lv5', 'spa_cat_lyr_lv5/in2');
