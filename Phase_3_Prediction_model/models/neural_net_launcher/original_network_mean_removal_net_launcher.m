...
function network=original_network_mean_removal_net_launcher(img_depth, img_row, img_col)
    ...
    pca_convolution_layer(name,input, kernel_size_z, kernel_size_x, kernel_size_y, num_filter);
    layers_lv1=[
