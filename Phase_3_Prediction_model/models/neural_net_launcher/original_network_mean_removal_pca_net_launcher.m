...
function network=original_network_mean_removal_pca_net_launcher(img_depth, img_row, img_col, num_classes)
   ...
   layers_cat_lv3=[
       ...
       maxPooling3dLayer([1 2 2],Stride=2,Name='max_lyr_lv3');
       ];
   ...
   layers_cat_lv4=[
       ...
       maxPooling3dLayer([1 2 2],Stride=2,Name='max_lyr_lv4');
       ];
