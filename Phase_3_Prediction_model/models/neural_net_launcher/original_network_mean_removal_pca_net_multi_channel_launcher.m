...
function network=original_network_mean_removal_pca_net_multi_channel_launcher(img_depth, img_row, img_col, num_classes, num_feature)
    ...
    layers_lv1=[
        ...
        image3dInputLayer([img_depth img_row img_col num_feature],Normalization="none",Name="input_lyr");
        % convolutional and relu layer
        mean_removal_lyr_lv1;
        % pca_conv_lyr_lv1;
        convolution3dLayer([1 3 3],2,Padding="same",Name='conv_lyr_lv1');
        reluLayer(Name='relu_lyr_lv1');
        ];
    network=dlnetwork(layers_lv1);   
    % setup concatenation layer
    layers_cat_lv1=[
        concatenationLayer(4,2,Name='cat_lyr_lv1');
        maxPooling3dLayer([1 2 2],Stride=2,Name="max_lyr_lv1");
        ];
   network=addLayers(network,layers_cat_lv1);
   network=connectLayers(network, 'relu_lyr_lv1', 'cat_lyr_lv1/in1');
   network=connectLayers(network, 'mean_removal_lyr_lv1', 'cat_lyr_lv1/in2');
   ...
   layers_lv2=[
       ...
       % pca_conv_lyr_xy_lv2;
       convolution3dLayer([1 3 3],4,Padding="same",Name='conv_lyr_xy_lv2');
   ...
   layers_z_lv2=[
       ...
       % pca_conv_lyr_z_lv2;
       convolution3dLayer([3 1 1],2,Padding="same",Name='conv_lyr_z_lv2');
       reluLayer(Name='relu_lyr_z_lv2');
   ];
   network=addLayers(network,layers_lv2);
   network=addLayers(network,layers_z_lv2);
   network=connectLayers(network, 'max_lyr_lv1', 'mean_removal_lyr_xy_lv2');
   network=connectLayers(network, 'max_lyr_lv1', 'mean_removal_lyr_z_lv2');
   % setup concatenation layer
   layers_cat_lv2=[
       concatenationLayer(4,3,Name='cat_lyr_lv2');
       maxPooling3dLayer([2 2 2],Stride=2,Name='max_lyr_lv2');
       ];
   ...
   network=connectLayers(network, 'mean_removal_lyr_xy_lv2', 'cat_lyr_lv2/in3');
   ...
   layers_lv3=[
       ...
       convolution3dLayer([1 1 1],1,Padding="same",Name='conv_lyr_red_lv3');
       mean_removal_lyr_xy_lv3;
       % pca_conv_lyr_xy_lv3
       convolution3dLayer([1 3 3],4,Padding="same",Name='conv_lyr_xy_lv3');
    ...
    layers_z_lv3=[
       ...
       % pca_conv_lyr_z_lv3
       convolution3dLayer([3 1 1],2,Padding="same",Name='conv_lyr_z_lv3');
       reluLayer(Name='relu_lyr_z_lv3');
    ];
   network=addLayers(network,layers_lv3);
   network=addLayers(network,layers_z_lv3);
   network=connectLayers(network, 'max_lyr_lv2', 'mean_removal_lyr_red_lv3');
   network=connectLayers(network, 'conv_lyr_red_lv3', 'mean_removal_lyr_z_lv3');
   % setup concatenational layer
   layers_cat_lv3=[
       concatenationLayer(4,3,Name='cat_lyr_lv3');
       maxPooling3dLayer([2 2 2],Stride=2,Name='max_lyr_lv3');
       ];
   ...
   network=connectLayers(network, 'mean_removal_lyr_red_lv3', 'cat_lyr_lv3/in3');
   ...
   layers_lv4=[
       ...
       convolution3dLayer([1 1 1],1,Padding="same",Name='conv_lyr_red_lv4');
       mean_removal_lyr_xy_lv4;
       % pca_conv_lyr_xy_lv4;
       convolution3dLayer([1 3 3],4,Padding="same",Name='conv_lyr_xy_lv4');
   ...
   layers_z_lv4=[
       ...
       % pca_conv_lyr_z_lv4;
       convolution3dLayer([3 1 1],2,Padding="same",Name='conv_lyr_z_lv4');
       reluLayer(Name='relu_lyr_z_lv4');
   ];
   network=addLayers(network,layers_lv4);
   network=addLayers(network,layers_z_lv4);
   network=connectLayers(network, 'max_lyr_lv3', 'mean_removal_lyr_red_lv4');
   network=connectLayers(network, 'conv_lyr_red_lv4', 'mean_removal_lyr_z_lv4');
   % setup concatenational layer
   layers_cat_lv4=[
       concatenationLayer(4,3,Name='cat_lyr_lv4');
       maxPooling3dLayer([2 2 2],Stride=2,Name='max_lyr_lv4');
       ];
   ...
   network=connectLayers(network, 'mean_removal_lyr_red_lv4', 'cat_lyr_lv4/in3');
   ...
   layers_lv5=[
       ...
       convolution3dLayer([1 1 1],1,Padding="same",Name='conv_lyr_red_lv5');
       mean_removal_lyr_xy_lv5;
       % pca_conv_lyr_xy_lv5;
       convolution3dLayer([1 3 3],6,Padding="same",Name='conv_lyr_xy_lv5');
   ...
   layers_z_lv5=[
       ...
       % pca_conv_lyr_z_lv5;
       convolution3dLayer([3 1 1],3,Padding="same",Name='conv_lyr_z_lv5');
       reluLayer(Name='relu_lyr_z_lv5');
   ];
   network=addLayers(network,layers_lv5);
   network=addLayers(network,layers_z_lv5);
   network=connectLayers(network, 'max_lyr_lv4', 'mean_removal_lyr_red_lv5');
   network=connectLayers(network, 'conv_lyr_red_lv5', 'mean_removal_lyr_z_lv5');
   ...
   layers_cat_lv5=[
       concatenationLayer(4,3,Name='cat_lyr_lv5');
       mean_removal_lyr_red_2_lv5;
       % pca_conv_lyr_red_2_lv5;
       convolution3dLayer([1 1 1],1,Padding="same",Name='conv_red_2_lyr_lv5');
       ];
   ...
   network=connectLayers(network, 'mean_removal_lyr_red_lv5', 'cat_lyr_lv5/in3');

   %% classification level
   layers_class_lv=[
       globalAveragePooling3dLayer(Name="global_avg_pool");
       fullyConnectedLayer(num_classes);
       softmaxLayer(Name='class_softmax_lyr');
       ];
    network=addLayers(network,layers_class_lv);
    network=connectLayers(network, 'conv_red_2_lyr_lv5', 'global_avg_pool');
