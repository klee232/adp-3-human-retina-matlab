...
function network=original_network_mean_removal_pca_net_multi_channel_launcher(img_depth, img_row, img_col, num_classes)
    ...
    layers_lv1=[
        ...
        image3dInputLayer([img_depth img_row img_col 2],Normalization="none",Name="input_lyr");
