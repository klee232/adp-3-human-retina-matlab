...
classdef GELU_layer < nnet.layer.Layer 
    ...
    methods
        ...
        function feat_map = predict(layer,input_feats)
            ...
            % conduct calculation
            first_element=(1/2)*(1+erf(input_feats./sqrt(2)));
            first_element=gpuArray(first_element);
            feat_map=input_feats.*first_element;
        ...
        function [dLdX] = backward(layer,input_feats,loss_feat)
            ...
            % conduct calculation
            first_element=(1/2)*(1+erf(input_feats./sqrt(2)));
            current_grad=first_element+input_feats*first_element;
