...
classdef Tanh_layer < nnet.layer.Layer 
    ...
    methods
        ...
        function feat_map = predict(layer,input_feats)
            ...
            second_element=e.^(-input_feats);
            feat_map=(first_element-second_element)/(first_element+second_element);
