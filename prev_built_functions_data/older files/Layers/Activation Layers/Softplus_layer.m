...
classdef Softplus_layer < nnet.layer.Layer 
    ...
    methods
        ...
        function [dLdX] = backward(layer,input_feats,loss_feat)
            ...
            % conduct calculation
            input_feats=gpuArray(input_feats);
            current_grad=1/(1+e.^(-input_feats));
