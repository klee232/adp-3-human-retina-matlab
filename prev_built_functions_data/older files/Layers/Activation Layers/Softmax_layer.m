...
classdef Softmax_layer < nnet.layer.Layer 
    ...
    methods
        ...
        function [dLdX] = backward(layer,feat_map,loss_feat)
            ...
            % conduct calculation
            first_element=feat_map.*(1-feat_map);
            current_grad=first_element;
