...
classdef LReLu_layer < nnet.layer.Layer 
    ...
    methods
        ...
        function feat_map = predict(layer,input_feats)
            ...
            feat_map(feat_map<=0)=0.01*feat_map(feat_map<=0);
        ...
        function [dLdX] = backward(layer,input_feats,loss_feat)
            ...
            out_gradient(input_feats<0)=0.01;
