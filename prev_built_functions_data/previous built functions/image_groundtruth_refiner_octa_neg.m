...
function [current_series,sign]=image_groundtruth_refiner_octa_neg(i_slice,filtered_octa_img_gt,current_series,current_series_oct)
        clf; close;
        sign="continue";
        ...
        % selection window z
        img_title=strcat("OCTA groundtruth (Negative binarization) Slice: ",string(i_slice));
