...
function [current_series,sign]=image_groundtruth_refiner_oct_pos(i_slice,filtered_oct_img_gt,current_series,current_series_oct)
    clf; close;
    sign="continue";
    ...
    % selection window z
    img_title=strcat("OCT groundtruth (Positive binarization) Slice: ", string(i_slice));
