...
% filtered_octa_img_gt: octa ground truth generated from the previous phase (3D image array)
...
function [current_series,sign]=image_groundtruth_refiner_octa_pos(i_slice,filtered_octa_img_gt,current_series,current_series_oct)
    clf; close;
    sign="continue";
    ...
    % selection window z
    img_title=strcat("OCTA groundtruth (Positive binarization) Slice: ",string(i_slice));
    ...
    while true
        ...
        elseif currentKey == 'q'
            ...
            if num_elements~=0
                ...
                for i_slice_crop=1:num_elements
                    ...
                    while true
                        ...
                        % Get the current key
                        currentKey = get(gcf, 'CurrentCharacter');
                        if currentKey == 'g' % case check pass
                            ...
                            % the filling)
                        elseif currentKey == 'q' % case check passed
                            figure; cla;
                            subplot(121);
                            imshow(cropped_reg_img);
                    ...
                    while true
                        ...
                        if button == 1 % Left mouse button click (case check passed)
                        ...
                        % Check if 'q' key is pressed (ASCII code for 'q'
                        % is 113) (case check passed)
                        if button == 113  % 'q' key
                            hold off
            ...
            % create function indicator for intermidiate terminate
            sign="break";
            indicator="octa-pos";
            % save intermediate file
            save("temp_data/octa_data_gt_series.mat","filtered_octa_img_gt");
